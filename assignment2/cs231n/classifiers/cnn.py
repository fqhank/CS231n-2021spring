...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        affine_relu_out, ar_cache = affine_relu_forward(conv_out,W2,b2)
        scores, af_cache = affine_forward(affine_relu_out,W3,b3)
